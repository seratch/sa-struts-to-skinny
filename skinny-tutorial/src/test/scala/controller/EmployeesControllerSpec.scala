...
class EmployeesControllerSpec extends FunSpec with Matchers with BeforeAndAfterAll with DBSettings {
  ...
  describe("EmployeesController") {
    ...
    describe("shows a employee") {
      it("shows HTML response") {
        ...
        controller.status should equal(200)
        controller.getFromRequestScope[Employee]("item") should equal(Some(employee))
